export const PROVIDER_ID = 'rucaptcha'
...
import * as solver from './rucaptcha-api'
...
async function getSolution(
  ...
  try {
    ...
    if (process.env['RUCAPTCHA_PROXY_TYPE'] && process.env['RUCAPTCHA_PROXY_ADDRESS']) {
         extraData['proxytype'] = process.env['RUCAPTCHA_PROXY_TYPE'].toUpperCase()
         extraData['proxy'] = process.env['RUCAPTCHA_PROXY_ADDRESS']
    }
