 ...
 * })
 */
export declare class Plugin extends PuppeteerExtraPlugin<PluginOptions> {
     ...
     * @ignore
     */
    onPageCreated(page: PuppeteerPage): Promise<void>;
}
declare const _default: (pluginConfig?: Partial<PluginOptions>) => Plugin;
